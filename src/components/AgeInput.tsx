...
export const AgeInput = ({ onAgeSubmit }: AgeInputProps) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-musical p-4">
      ...
      <Card className="relative z-10 w-full max-w-md p-8 bg-card/90 backdrop-blur-sm shadow-musical border-0">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold bg-gradient-musical bg-clip-text text-transparent mb-2">
            Age of Cantopop
          </h1>
          <p className="text-muted-foreground">
            Discover Cantopop songs that reference your age
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="text-center text-lg h-12 border-2 border-border focus:border-primary transition-smooth"
              min="0"
              max="10000"
              step="0.1"
            />
          ...
          <Button 
            type="submit" 
            className="w-full h-12 bg-gradient-musical hover:scale-105 transition-bounce shadow-soft"
            disabled={!age}
          >
